...
import { GuessTheCurrencyGame } from '@/features/guess-the-currency/components/guess-the-currency-game'
import { GUESS_THE_CURRENCY_GAME_ID } from '@/features/guess-the-currency/constants'

export function GuessTheCurrencyPage() {
        ...
        <>
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-2 text-sm text-muted-foreground sm:mt-3 sm:text-lg">
              ...
              steering toward less familiar nations.
            </p>
          </div>
        </>
      ) : null}

      <GuessTheCurrencyGame
        onPhaseChange={(phase) => {
